...
<html lang="en" dir="ltr">
   <head>
      ...
      <link rel="stylesheet" href="backend/css/customizeMessage.css">
   ...
   <body class=" ">
         ...
         <section class="login-content">
            <div class="row m-0 align-items-center bg-white h-100">
                        ...
                        <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card iq-auth-form">
                           <div class="card-body">
                              ...
                              <form method="post" action="{{ route('auth.login') }}">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="form-group">
                                          ...
                                          <input type="password" name="password" class="form-control" id="password" aria-describedby="password" placeholder=" "> @if ($errors->has('password')) <span class="error-message">{{ $errors->first('password')}}</span> @endif
                                       </div>
                                    </div>
                                 ...
                                 <p class="mt-3 text-center"> Don’t have an account? <a href="sign-up.html" class="text-underline">Click here to sign up.</a>
                                 </p>
                              </form>
                           </div>
                        </div>
               ...
               <div class="col-md-6 d-md-block d-none bg-primary p-0 vh-100 overflow-hidden">
                  <img src="backend/images/auth/01.png" class="img-fluid gradient-main animated-scaleX" alt="images" loading="lazy">
               </div>
            </div>
         </section>
      </div>
      ...
      <script src="backend/js/sidebar.js?v=2.2.0" defer=""></script>
   </body>
</html>
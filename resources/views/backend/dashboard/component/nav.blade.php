                        ...
                        <div class="m-0 shadow-none card">
                           ...
                           <div class="p-0 card-body max-17 scroll-thin">
                              <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                       <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="{{ asset( 'backend/images/shapes/01.png' ) }}" alt="" loading="lazy" />
                              ...
                              <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                       <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="{{ asset( 'backend/images/shapes/02.png' ) }}" alt="" loading="lazy" />
                                       <div class="ms-3 flex-grow-1">
                              ...
                              <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                       <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="{{ asset( 'backend/images/shapes/03.png' ) }}" alt="" loading="lazy" />
                                       <div class="ms-3 flex-grow-1">
                              ...
                              <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                       <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="{{ asset( 'backend/images/shapes/04.png' ) }}" alt="" loading="lazy" />
                                       <div class="ms-3 flex-grow-1">

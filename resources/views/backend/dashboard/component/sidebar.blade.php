            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
               <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-user" role="button" aria-expanded="false" aria-controls="sidebar-user">
                     ...
                     <span class="item-name">QL Thành Viên</span>
                     <i class="right-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" class="icon-20" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                  ...
                  <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                     <li class="nav-item">
                        <a class="nav-link" href="index-horizontal.html">
                           <span class="item-name">QL Nhóm Thành Viên</span>
                        </a>
                     </li>
                     <li class="nav-item">
               ...
               <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-table" role="button" aria-expanded="false" aria-controls="sidebar-table">
                     ...
                     <span class="item-name">QL Thư Viện</span>
                     <i class="right-icon">
                  ...
                  <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
                     <li class="nav-item active">
                        <a class="nav-link" href="{{ route('book.index') }}">
                           <span class="item-name">QL Thư Viện Sách</span>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="{{ route('rental.index') }}">
                           <span class="item-name">QL Đơn Cho Thuê</span>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="{{ route('overdue.index') }}">
                           <span class="item-name">QL Đơn Quá Hạn</span>
                        </a>
                     </li>

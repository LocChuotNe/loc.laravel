                        ...
                        <div class="col-md-6">
                            <div class="iq-scroller-effect">
                                ...
                                <div class="d-flex align-items-center iq-slider mb-4 gap-2">
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{ asset( 'backend/images/table/1.png' ) }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{ asset( 'backend/images/table/2.png' ) }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{ asset( 'backend/images/table/3.png' ) }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{ asset( 'backend/images/table/4.png' ) }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2" src="{{ asset( 'backend/images/table/5.png' ) }}" alt="profile" loading="lazy" />
                                    </div>
                                </div>
                                <div>
            ...
            <div class="card card-block card-stretch card-height">
                <nav class="tab-bottom-bordered">
                    <div class="mb-0 nav nav-tabs justify-content-around" id="nav-tab1" role="tablist">
                        ...
                        <button class="nav-link py-3" id="nav-profile-11-tab" data-bs-toggle="tab" data-bs-target="#nav-profile-11" type="button" role="tab" aria-controls="nav-profile-11" aria-selected="false">
                            Settlements
                        </button>

...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="backend/css/core/libs.min.css">

        <!-- Hope Ui Design System Css -->
        <link rel="stylesheet" href="backend/css/hope-ui.min.css?v=2.2.0">
        <link rel="stylesheet" href="backend/css/pro.min.css?v=2.2.0">

        <!-- Custom Css -->
        <link rel="stylesheet" href="backend/css/custom.min.css?v=2.2.0">

        <!-- Dark Css -->
        <link rel="stylesheet" href="backend/css/dark.min.css?v=2.2.0">

        <!-- Customizer Css -->
        <link rel="stylesheet" href="backend/css/customizer.min.css?v=2.2.0">

        <!-- RTL Css -->
        <link rel="stylesheet" href="backend/css/rtl.min.css?v=2.2.0">
    ...
    <body class="  ">
        ...
        <div class="loader simple-loader">
            <div class="loader-body">
                <img src="backend/images/loader.webp" alt="loader" class="light-loader img-fluid w-25" width="200" height="200">
            </div>
        </div>
        </div>
        <!-- loader END -->
            ...
            <div class="sidebar-body pt-0 data-scrollbar">
                <div class="sidebar-list">
                    ...
                    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="alternate-dashboard.html">
                                <i class="icon" data-bs-toggle="tooltip" title="Alternate Dashboard" data-bs-placement="right">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" viewbox="0 0 24 24" fill="none">
                                        <path opacity="0.4" d="M2 4C2 2.89543 2.89543 2 4 2H9C10.1046 2 11 2.89543 11 4V20C11 21.1046 10.1046 22 9 22H4C2.89543 22 2 21.1046 2 20V4Z" fill="currentColor"></path>
                            ...
                            <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="index-dual-horizontal.html">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Dual Horizontal" data-bs-placement="right"> D </i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="https://templates.iqonic.design/hope-ui/pro/html/" target="_blank">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#e-commerce" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            ...
                            <ul class="sub-nav collapse" id="e-commerce" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="../e-commerce/index.html">
                                        <i class="icon">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Admin Dashboard" data-bs-placement="right"> AD </i>
                                        <span class="item-name"> Admin Dashboard</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="../e-commerce/vendor-dashboard.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#shop-main" role="button" aria-expanded="false" aria-controls="shop-main">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                                    ...
                                    <ul class="sub-nav collapse" id="shop-main" data-bs-parent="#e-commerce">
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page" href="../e-commerce/shop-main.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Shop Main" data-bs-placement="right"> SM </i>
                                                <span class="item-name">Shop Main</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="../e-commerce/shop-left-filter.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Shop - Left Filter" data-bs-placement="right"> SL </i>
                                                <span class="item-name">Shop - Left Filter</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="../e-commerce/shop-right-filter.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Shop - Right Filter" data-bs-placement="right"> SR </i>
                                                <span class="item-name">Shop - Right Filter</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link product-grid" aria-current="page" href="../e-commerce/products.html?type=product-grid">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Product Grid View" data-bs-placement="right"> PG </i>
                                                <span class="item-name">Product Grid View</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link product-list" aria-current="page" href="../e-commerce/products.html?type=product-list">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Product List View" data-bs-placement="right"> PL </i>
                                                <span class="item-name">Product List View</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="../e-commerce/categories-list.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Categories List" data-bs-placement="right"> C </i>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#products" role="button" aria-expanded="false" aria-controls="products">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Product Detail" data-bs-placement="right"> PD </i>
                                    ...
                                    <ul class="sub-nav collapse" id="products" data-bs-parent="#e-commerce">
                                        <li class="nav-item">
                                            <a class="nav-link " href="../e-commerce/product-detail.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Product Detail" data-bs-placement="right"> P </i>
                                                <span class="item-name">Product Detail</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="../e-commerce/product-detail-3d.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="3D Product Detail" data-bs-placement="right"> 3D </i>
                                                <span class="item-name">3D Product Detail</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="../e-commerce/product-detail-360.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="360 Product Detail" data-bs-placement="right"> P </i>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="../e-commerce/order-process.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Order Process" data-bs-placement="right"> OP </i>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="../e-commerce/invoice.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../e-commerce/wishlist.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../e-commerce/user-profile.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../e-commerce/user-list.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#social" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            ...
                            <ul class="sub-nav collapse" id="social" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="../social-app/index.html">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Social Dashboard" data-bs-placement="right"> D </i>
                                        <span class="item-name">Dashboard</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#friends" role="button" aria-expanded="false" aria-controls="friends">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <ul class="sub-nav collapse" id="friends" data-bs-parent="#social">
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/friend-list.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Friends List" data-bs-placement="right"> FL </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/friend-request.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Friend Request" data-bs-placement="right"> FR </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/friend-profile.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Friend Profile" data-bs-placement="right"> FP </i>
                                    ...
                                    <ul class="sub-nav collapse" id="profile" data-bs-parent="#social">
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/profile-badges.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Profile Badges" data-bs-placement="right"> PB </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/profile-images.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Profile Images" data-bs-placement="right"> PI </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/profile-video.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Profile Videos" data-bs-placement="right"> PV </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/birthday.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Birthday" data-bs-placement="right"> B </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/notification.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Notification" data-bs-placement="right"> N </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/account-setting.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Account Setting" data-bs-placement="right"> A </i>
                                    ...
                                    <ul class="sub-nav collapse" id="event" data-bs-parent="#social">
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/event-list.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Profile Event" data-bs-placement="right"> P </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/event-detail.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Event Detail" data-bs-placement="right"> E </i>
                                    ...
                                    <ul class="sub-nav collapse" id="group" data-bs-parent="#social">
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/group.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Group List" data-bs-placement="right"> G </i>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="../social-app/group-detail.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Group Detail" data-bs-placement="right"> GD </i>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../social-app/social-profile.html">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Social Profile" data-bs-placement="right"> S </i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#blog" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            ...
                            <ul class="sub-nav collapse" id="blog" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="../blog/index.html">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Blog Dashboard" data-bs-placement="right"> D </i>
                                        <span class="item-name">Dashboard</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#blog1" role="button" aria-expanded="false" aria-controls="blog">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83V17.16C3 20.26 4.77 22 7.81 22H16.191C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2Z" fill="currentColor"></path>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.07996 6.6499V6.6599C7.64896 6.6599 7.29996 7.0099 7.29996 7.4399C7.29996 7.8699 7.64896 8.2199 8.07996 8.2199H11.069C11.5 8.2199 11.85 7.8699 11.85 7.4289C11.85 6.9999 11.5 6.6499 11.069 6.6499H8.07996ZM15.92 12.7399H8.07996C7.64896 12.7399 7.29996 12.3899 7.29996 11.9599C7.29996 11.5299 7.64896 11.1789 8.07996 11.1789H15.92C16.35 11.1789 16.7 11.5299 16.7 11.9599C16.7 12.3899 16.35 12.7399 15.92 12.7399ZM15.92 17.3099H8.07996C7.77996 17.3499 7.48996 17.1999 7.32996 16.9499C7.16996 16.6899 7.16996 16.3599 7.32996 16.1099C7.48996 15.8499 7.77996 15.7099 8.07996 15.7399H15.92C16.319 15.7799 16.62 16.1199 16.62 16.5299C16.62 16.9289 16.319 17.2699 15.92 17.3099Z" fill="currentColor"></path>
                                    ...
                                    <ul class="sub-nav collapse" id="blog1" data-bs-parent="#blog">
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page" href="../blog/blog-main.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Blog Main" data-bs-placement="right">BM</i>
                                                <span class="item-name">Blog Main</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page" href="../blog/blog-detail.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Blog Detail" data-bs-placement="right">BD</i>
                                                <span class="item-name">Blog Details</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page" href="../blog/blog-grid.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Blog Grid" data-bs-placement="right">BG</i>
                                                <span class="item-name">Blog Grid</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " aria-current="page" href="../blog/blog-list.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Blog List" data-bs-placement="right">BL</i>
                                                <span class="item-name">Blog List</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="../blog/blog-trending.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Blog Trending" data-bs-placement="right">BT</i>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../blog/blog-comments.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul class="sub-nav collapse" id="appointment" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="../appointment/index.html">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Appointment" data-bs-placement="right">A</i>
                                        <span class="item-name">Appointment</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="../appointment/book-appointment.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M3 16.87V9.25699H21V16.931C21 20.07 19.0241 22 15.8628 22H8.12733C4.99561 22 3 20.03 3 16.87ZM7.95938 14.41C7.50494 14.431 7.12953 14.07 7.10977 13.611C7.10977 13.151 7.46542 12.771 7.91987 12.75C8.36443 12.75 8.72997 13.101 8.73985 13.55C8.7596 14.011 8.40395 14.391 7.95938 14.41ZM12.0198 14.41C11.5653 14.431 11.1899 14.07 11.1701 13.611C11.1701 13.151 11.5258 12.771 11.9802 12.75C12.4248 12.75 12.7903 13.101 12.8002 13.55C12.82 14.011 12.4643 14.391 12.0198 14.41ZM16.0505 18.09C15.596 18.08 15.2305 17.7 15.2305 17.24C15.2206 16.78 15.5862 16.401 16.0406 16.391H16.0505C16.5148 16.391 16.8902 16.771 16.8902 17.24C16.8902 17.71 16.5148 18.09 16.0505 18.09ZM11.1701 17.24C11.1899 17.7 11.5653 18.061 12.0198 18.04C12.4643 18.021 12.82 17.641 12.8002 17.181C12.7903 16.731 12.4248 16.38 11.9802 16.38C11.5258 16.401 11.1701 16.78 11.1701 17.24ZM7.09989 17.24C7.11965 17.7 7.49506 18.061 7.94951 18.04C8.39407 18.021 8.74973 17.641 8.72997 17.181C8.72009 16.731 8.35456 16.38 7.90999 16.38C7.45554 16.401 7.09989 16.78 7.09989 17.24ZM15.2404 13.601C15.2404 13.141 15.596 12.771 16.0505 12.761C16.4951 12.761 16.8507 13.12 16.8705 13.561C16.8804 14.021 16.5247 14.401 16.0801 14.41C15.6257 14.42 15.2503 14.07 15.2404 13.611V13.601Z" fill="currentColor"></path>
                                                <path opacity="0.4" d="M3.00336 9.2569C3.0162 8.6699 3.0656 7.5049 3.15846 7.1299C3.63267 5.0209 5.24298 3.6809 7.54485 3.4899H16.4559C18.738 3.6909 20.3681 5.0399 20.8423 7.1299C20.9342 7.4949 20.9836 8.6689 20.9964 9.2569H3.00336Z" fill="currentColor"></path>
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Book Appointment" data-bs-placement="right">BA</i>
                                        <span class="item-name">Book Appointment</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="../appointment/doctor-visit.html">
                                        <i class="icon">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Doctor Visit" data-bs-placement="right"> DV </i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#file-manager" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            ...
                            <ul class="sub-nav collapse" id="file-manager" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="../file-manager/index.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="File Manager - Dashboard" data-bs-placement="right">D</i>
                                        <span class="item-name">Dashboard</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="../file-manager/image-folder.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../file-manager/video-folder.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../file-manager/document-folder.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" d="M18.8088 9.021C18.3573 9.021 17.7592 9.011 17.0146 9.011C15.1987 9.011 13.7055 7.508 13.7055 5.675V2.459C13.7055 2.206 13.5036 2 13.253 2H7.96363C5.49517 2 3.5 4.026 3.5 6.509V17.284C3.5 19.889 5.59022 22 8.16958 22H16.0463C18.5058 22 20.5 19.987 20.5 17.502V9.471C20.5 9.217 20.299 9.012 20.0475 9.013C19.6247 9.016 19.1177 9.021 18.8088 9.021Z" fill="#currentColor"></path>
                                                <path opacity="0.4" d="M16.084 2.56729C15.785 2.25629 15.263 2.47029 15.263 2.90129V5.53829C15.263 6.64429 16.174 7.55429 17.28 7.55429C17.977 7.56229 18.945 7.56429 19.767 7.56229C20.188 7.56129 20.402 7.05829 20.11 6.75429C19.055 5.65729 17.166 3.69129 16.084 2.56729Z" fill="#currentColor"></path>
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Documents" data-bs-placement="right">D</i>
                                        <span class="item-name">Documents</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="../file-manager/all-files.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="All Files" data-bs-placement="right">AF</i>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="../file-manager/trash.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#mail" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            ...
                            <ul class="sub-nav collapse" id="mail" data-bs-parent="#sidebar-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="../mail/email-compose.html">
                                        <i class="icon">
                                            <svg width="20" class="icon-20" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Email Compose" data-bs-placement="right">EC</i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth1" role="button" aria-expanded="false" aria-controls="sidebar-user">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Default" data-bs-placement="right">DE</i>
                                    ...
                                    <ul class="sub-nav collapse" id="sidebar-auth1" data-bs-parent="#sidebar-auth">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth/recoverpw.html">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Recover Password" data-bs-placement="right"> R </i>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth2" role="button" aria-expanded="false" aria-controls="sidebar-user">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Animated" data-bs-placement="right">AN</i>
                                    ...
                                    <ul class="sub-nav collapse" id="sidebar-auth2" data-bs-parent="#sidebar-auth">
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth-pro/sign-in.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Sign In" data-bs-placement="right"> SI </i>
                                                <span class="item-name">Sign in</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth-pro/sign-up.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Sign up" data-bs-placement="right"> S </i>
                                                <span class="item-name">Sign up</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth-pro/email.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Email" data-bs-placement="right"> E </i>
                                                <span class="item-name">Email</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth-pro/lock-screen.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth-pro/reset-password.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Reset Password" data-bs-placement="right"> RP </i>
                                                <span class="item-name">Reset Password</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth-pro/two-factor.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="auth-pro/account-deactivate.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth3" role="button" aria-expanded="false" aria-controls="sidebar-user">
                                    ...
                                    <ul class="sub-nav collapse" id="sidebar-auth3" data-bs-parent="#sidebar-auth">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Sign Up" data-bs-placement="right"> SU </i>
                                                <span class="item-name">Sign Up</span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth4" role="button" aria-expanded="false" aria-controls="sidebar-user">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Simple" data-bs-placement="right">SM</i>
                                    ...
                                    <ul class="sub-nav collapse" id="sidebar-auth4" data-bs-parent="#sidebar-auth">
                                        <li class="nav-item">
                                            <a class="nav-link" href="simple-auth-pro/sign-in.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Sign In" data-bs-placement="right"> S </i>
                                                <span class="item-name">Sign In</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="simple-auth-pro/sign-up.html">
                                                <i class="icon">
                                                    <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="sidebar-plugins" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="plugins/apexcharts.html">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="plugins/button-hover.html">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="plugins/tree-view.html">
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Button Hover" data-bs-placement="right"> TV </i>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="plugins/loader.html">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="blank-page.html">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="table/border-table.html">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="table/fancy-table.html">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="table/fixed-table.html">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewbox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                   ...
                   <div class="container-fluid navbar-inner">
                               ...
                               <ul class="iq-nav-menu list-unstyled">
                                  <li class="nav-item active">
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                        ...
                                        <li class="nav-item"><a class="nav-link " href="alternate-dashboard.html">Alternate Dashboard</a></li>
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="menuStyles">
                                              ...
                                              <li class="nav-item"><a class="nav-link " href="index-dual-horizontal.html">Dual Horizontal Dashboard</a>
                                              </li>
                                        ...
                                        <li class="nav-item"><a class="nav-link " href="../e-commerce/index.html">E-Commerce</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../social-app/index.html">Social App</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../blog/index.html">Blog</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../appointment/index.html">Appointment</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../file-manager/index.html">File Manager</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../chat/index.html" target="_blank">Chat</a></li>
                                        <li class="nav-item"><a class="nav-link " href="../mail/index.html">Mail</a></li>
                                     </ul>
                                  </li>
                                  <li class="nav-item">
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="specialPages">
                                              <li class="nav-item"><a class="nav-link " href="special-pages/billing.html">Billing</a></li>
                                              <li class="nav-item"><a class="nav-link " href="special-pages/calender.html">Calender</a></li>
                                              <li class="nav-item"><a class="nav-link " href="special-pages/kanban.html">Kanban</a></li>
                                              <li class="nav-item"><a class="nav-link " href="special-pages/pricing.html">Pricing</a></li>
                                              <li class="nav-item"><a class="nav-link " href="special-pages/timeline.html">Timeline</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="authSkins">
                                              <li class="nav-item">
                                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#defaultAuth" role="button" aria-expanded="false" aria-controls="defaultAuth">
                                                    Default
                                                    <i class="right-icon">
                                                       <svg class="icon-20" width="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                 ...
                                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="defaultAuth">
                                                    <li class="nav-item"><a class="nav-link " href="auth/sign-in.html">Sign In</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth/sign-up.html">Sign Up</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth/confirm-mail.html">Email Verified</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth/recoverpw.html">Reset Password</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth/lock-screen.html">Lock Screen</a></li>
                                                 </ul>
                                              </li>
                                              <li class="nav-item">
                                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#animatedAuth" role="button" aria-expanded="false" aria-controls="animatedAuth">
                                                    Animated
                                                    <i class="right-icon">
                                                       <svg class="icon-20" width="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                 ...
                                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="animatedAuth">
                                                    <li class="nav-item"><a class="nav-link " href="auth-pro/sign-in.html">Sign In</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth-pro/sign-up.html">Sign Up</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth-pro/email.html">Email</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth-pro/lock-screen.html">Lock screen</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth-pro/reset-password.html">Reset password</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth-pro/two-factor.html">Two factor</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth-pro/account-deactivate.html">Account
                                                          deactivate</a></li>
                                                 </ul>
                                              </li>
                                              <li class="nav-item">
                                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#popupAuth" role="button" aria-expanded="false" aria-controls="popupAuth">
                                                    popup
                                                    <i class="right-icon">
                                                       <svg class="icon-20" width="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                 ...
                                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="popupAuth">
                                                    <li class="nav-item"><a class="nav-link " href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Sign In</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">Sign Up</a></li>
                                                 </ul>
                                              </li>
                                              <li class="nav-item">
                                                 <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#simpleAuth" role="button" aria-expanded="false" aria-controls="simpleAuth">
                                                    simple
                                                    <i class="right-icon">
                                                       <svg class="icon-20" width="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                          <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                 ...
                                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="simpleAuth">
                                                    <li class="nav-item"><a class="nav-link " href="simple-auth-pro/sign-in.html">Sign In</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="simple-auth-pro/sign-up.html">Sign Up</a></li>
                                                 </ul>
                                              </li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="userApps">
                                              <li class="nav-item"><a class="nav-link " href="app/user-profile.html">User Profile</a></li>
                                              <li class="nav-item"><a class="nav-link " href="app/user-add.html">User Add</a></li>
                                              <li class="nav-item"><a class="nav-link " href="app/user-list.html">User List</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="utilities">
                                              <li class="nav-item"><a class="nav-link " href="errors/maintenance.html">Maintenance</a></li>
                                              <li class="nav-item"><a class="nav-link " href="errors/error404.html">404</a></li>
                                              <li class="nav-item"><a class="nav-link " href="errors/error500.html">505</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="extraPlugins">
                                              <li class="nav-item"><a class="nav-link " href="plugins/button-hover.html">Button Hover</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/choise-js.html">Choise JS</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/fslightbox.html">FSlightbox</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/select2.html">Select2</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/sweet-alert.html">Sweetalert</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/flatpickr.html">flatpickr</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/apexcharts.html">Apexcharts</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/gallery-hover.html">Gallery Hover</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/image-croper.html">Image Croper</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/loader.html">Loader</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/rating.html">Rating</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/quill-editor.html">Quill</a></li>
                                              <li class="nav-item"><a class="nav-link " href="plugins/uppy.html">Uppy</a></li>
                                           </ul>
                                        </li>
                                     </ul>
                                  </li>
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                        ...
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="widgetsPage">
                                              <li class="nav-item"><a class="nav-link " href="widget/widgetbasic.html">Widget Basic</a></li>
                                              <li class="nav-item"><a class="nav-link " href="widget/widgetchart.html">Widget Chart</a></li>
                                              <li class="nav-item"><a class="nav-link " href="widget/widgetcard.html">Widget Card</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="mapPages">
                                              <li class="nav-item"><a class="nav-link " href="maps/google.html">Google</a></li>
                                              <li class="nav-item"><a class="nav-link " href="maps/vector.html">Vector</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="tablesPages">
                                              <li class="nav-item"><a class="nav-link " href="table/bootstrap-table.html">Bootstrap Table</a></li>
                                              <li class="nav-item"><a class="nav-link " href="table/table-data.html">Data Table</a></li>
                                              <li class="nav-item"><a class="nav-link " href="table/border-table.html">Bordered Table</a></li>
                                              <li class="nav-item"><a class="nav-link " href="table/fancy-table.html">Fancy Table</a></li>
                                              <li class="nav-item"><a class="nav-link " href="table/fixed-table.html">Fixed Table</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="iconsPages">
                                              <li class="nav-item"><a class="nav-link " href="icons/solid.html">Solid</a></li>
                                              <li class="nav-item"><a class="nav-link " href="icons/outline.html">Outlined</a></li>
                                              <li class="nav-item"><a class="nav-link " href="icons/dual-tone.html">Dual Tone</a></li>
                                           </ul>
                                        </li>
                                     </ul>
                                  </li>
                         ...
                         <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                                  ...
                                  <div class="m-0 shadow-none card">
                                     ...
                                     <div class="p-0 card-body max-17 scroll-thin">
                                        <div class="iq-sub-card">
                                           <div class="d-flex align-items-center">
                                              <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="backend/images/shapes/01.png" alt="" loading="lazy">
                                        ...
                                        <div class="iq-sub-card">
                                           <div class="d-flex align-items-center">
                                              <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="backend/images/shapes/02.png" alt="" loading="lazy">
                                              <div class="ms-3 flex-grow-1">
                                        ...
                                        <div class="iq-sub-card">
                                           <div class="d-flex align-items-center">
                                              <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="backend/images/shapes/03.png" alt="" loading="lazy">
                                              <div class="ms-3 flex-grow-1">
                                        ...
                                        <div class="iq-sub-card">
                                           <div class="d-flex align-items-center">
                                              <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="backend/images/shapes/04.png" alt="" loading="lazy">
                                              <div class="ms-3 flex-grow-1">
                            ...
                            <li class="nav-item dropdown" id="itemdropdown1">
                               ...
                               <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                  ...
                                  <li>
                                     <a class="dropdown-item" href="{{ route('auth.loguot') }}">Logout</a>
                                  </li>
                               </ul>
                            </li>
                    ...
                    <div class="iq-navbar-header" style="height: 215px;">
                        ...
                        <div class="iq-header-img">
                            <img src="backend/images/dashboard/top-header.png" alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="backend/images/dashboard/top-header1.png" alt="header" class="theme-color-purple-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="backend/images/dashboard/top-header2.png" alt="header" class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="backend/images/dashboard/top-header3.png" alt="header" class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="backend/images/dashboard/top-header4.png" alt="header" class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="backend/images/dashboard/top-header5.png" alt="header" class="theme-color-pink-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                        </div>
                            ...
                            <div class="p-3">
                                    ...
                                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                                        <div data-setting="attribute" class="text-center">
                                            ...
                                            <label class="btn btn-border d-block p-0" for="theme-scheme-direction-ltr">
                                                <img src="backend/images/settings/dark/01.png" alt="ltr" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/01.png" alt="ltr" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="attribute" class="text-center">
                                            ...
                                            <label class="btn btn-border d-block p-0" for="theme-scheme-direction-rtl">
                                                <img src="backend/images/settings/dark/02.png" alt="ltr" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/02.png" alt="ltr" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                ...
                                <div data-setting="checkbox">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" value="sidebar-none" class="btn-check" name="sidebar_show" id="switch-sidebar-show" type="checkbox">
                                        </div>
                                    </div>
                                </div>
                                <!-- menu hide end here -->
                                    ...
                                    <div class="d-grid gap-3 grid-cols-4 mb-4">
                                        <div data-setting="checkbox" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-mini">
                                                <img src="backend/images/settings/dark/03.png" alt="mini" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/03.png" alt="mini" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="checkbox" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-hover">
                                                <img src="backend/images/settings/dark/04.png" alt="hover" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/04.png" alt="hover" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="checkbox" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-boxed">
                                                <img src="backend/images/settings/dark/05.png" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/05.png" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                    ...
                                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-rounded">
                                                <img src="backend/images/settings/dark/06.png" alt="mini" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/06.png" alt="mini" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-rounded-all">
                                                <img src="backend/images/settings/dark/07.png" alt="hover" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/07.png" alt="hover" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill">
                                                <img src="backend/images/settings/dark/08.png" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/08.png" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill-all">
                                                <img src="backend/images/settings/dark/09.png" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/09.png" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border position-relative p-0 d-block overflow-hidden" for="left-bordered">
                                                <img src="backend/images/settings/dark/14.png" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/14.png" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border position-relative p-0 d-block overflow-hidden" for="navs-full-width">
                                                <img src="backend/images/settings/dark/15.png" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/15.png" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                                <small class="badge bg-danger position-absolute top-1 end-0 m-2">Pro</small>
                                            </label>
                                ...
                                <div data-setting="checkbox">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" value="iq-navbar-none" class="btn-check" name="header_navbar_show" id="switch-navbar-show" type="checkbox">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-grid gap-3 grid-cols-4 mb-4">
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="nav-glass">
                                                <img src="backend/images/settings/dark/10.png" alt="hover" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/10.png" alt="hover" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-transparent">
                                                <img src="backend/images/settings/dark/12.png" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/12.png" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            ...
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-default">
                                                <img src="backend/images/settings/dark/01.png" alt="default" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/01.png" alt="default" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                ...
                                <div>
                                    ...
                                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                                        <div data-setting="radio" class="text-center">
                                            <input type="radio" value="navs-bg-color" class="btn-check" name="header_banner" id="header-banner-color">
                                            <label class="btn btn-border p-0 d-block overflow-hidden" for="header-banner-color">
                                                <img src="backend/images/settings/dark/11.png" alt="hover" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/11.png" alt="hover" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                            <span class="mt-2">Color</span>
                                        </div>
                                        <div data-setting="radio" class="text-center">
                                            <input type="radio" value="default" class="btn-check" name="header_banner" id="header-banner-default">
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            <input type="radio" value="hide" class="btn-check" name="header_banner" id="hide-banner" checked="">
                                            <label class="btn btn-border position-relative p-0 d-block overflow-hidden" for="hide-banner">
                                                <img src="backend/images/settings/dark/05.png" alt="boxed" class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="backend/images/settings/light/05.png" alt="boxed" class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                                <small class="badge bg-danger position-absolute top-1 end-0 m-2">Pro</small>
                                            </label>
                ...
                <form action="#" autocomplete="off">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <li class="list-group-item border-0 pb-0">
                            <a href="#"><img src="backend/images/brands/fb.svg" alt="fb" loading="lazy"></a>
                        </li>
                        <li class="list-group-item border-0 pb-0">
                            <a href="#"><img src="backend/images/brands/gm.svg" alt="gm" loading="lazy"></a>
                        </li>
                        <li class="list-group-item border-0 pb-0">
                            <a href="#"><img src="backend/images/brands/im.svg" alt="im" loading="lazy"></a>
                        </li>
                        <li class="list-group-item border-0 pb-0">
                            <a href="#"><img src="backend/images/brands/li.svg" alt="li" loading="lazy"></a>
                        </li>
                        </ul>
                    </div>
        ...
        <script src="backend/js/core/libs.min.js"></script>
        <!-- Plugin Scripts -->
        ...
        <!-- Slider-tab Script -->
        <script src="backend/js/plugins/slider-tabs.js"></script>
        ...
        <!-- Lodash Utility -->
        <script src="backend/vendor/lodash/lodash.min.js"></script>
        <!-- Utilities Functions -->
        <script src="backend/js/iqonic-script/utility.min.js"></script>
        <!-- Settings Script -->
        <script src="backend/js/iqonic-script/setting.min.js"></script>
        <!-- Settings Init Script -->
        <script src="backend/js/setting-init.js"></script>
        <!-- External Library Bundle Script -->
        <script src="backend/js/core/external.min.js"></script>
        <!-- Widgetchart Script -->
        <script src="backend/js/charts/widgetcharts.js?v=2.2.0" defer=""></script>
        <!-- Dashboard Script -->
        <script src="backend/js/charts/dashboard.js?v=2.2.0" defer=""></script>
        <script src="backend/js/charts/alternate-dashboard.js?v=2.2.0" defer=""></script>
        <!-- Hopeui Script -->
        <script src="backend/js/hope-ui.js?v=2.2.0" defer=""></script>
        <script src="backend/js/hope-uipro.js?v=2.2.0" defer=""></script>
        <script src="backend/js/sidebar.js?v=2.2.0" defer=""></script>    </body>
</html>

<div class="align-items-center product-offcanvas">
    <div class="breadcrumb-title breadcrumb-title-custom border-end me-3 pe-3 d-none d-xl-block">
        <small class="text-capitalize text-capitalize-custom">{{ config('apps.rental.titleRental')}}</small>
    </div>
    <ul class="d-flex ">
        <li class="">
        ...
        <li class="">/</li>
        <li class=""><strong>{{ config('apps.rental.titleRental')}}</strong></li>
    </ul>
</div>
            ...
            <div class="card">
                ...
                <div class="card-body px-0">
                    <div class="table-left-bordered table-responsive-custom">
                        @include('backend.library.rental.component.filter')

                        @include('backend.library.rental.component.table')
                    </div>
                </div>
            </div>
        </div>

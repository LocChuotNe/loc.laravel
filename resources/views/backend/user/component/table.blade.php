                    ...
                    <td>
                        <div class="">
                            <td class="media-support-info">
                                ...
                                <div class="mb-1 address-item ward"><strong>Phường/Xã</strong>: Phúc La</div>
                                <div class="mb-1 address-item district"><strong>Quận/Huyện</strong>: Hà Đông</div>
                                <div class="mb-0 address-item city"><strong>Thành Phố</strong>: Hà Nội</div>
                            </td>
                        </div>
                    </td>
                    <td class="text-dark">
                        <div class="mb-0 d-flex justify-content-between phone-item phone">{{ $user->phone }}</div>
                    </td>
                    <td class="text-dark">
                        <div class="mb-0 d-flex justify-content-between email-item email">{{ $user->email }}</div>
                    </td>
                    <td class="text-dark">548</td>
                    <td>
                        <div class="form-check form-switch">
                            <input class="form-check-input form-check-input-custom" type="checkbox" id="flexSwitchCheckDefault">
                        </div>
                    </td>
                    <td>
                        <div class="d-flex justify-content-evenly">
                            <a class="btn btn-primary btn-icon btn-sm rounded-pill" href="{{ route('user.component.create') }}" role="button">
